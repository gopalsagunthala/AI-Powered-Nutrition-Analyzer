    ...
    <div className="footer">
        ...
        <div className="sb_footer-links">
            <div className="sb_footer-links-div">
                <h4>Team Members</h4>
                <a href="/employee"><p><IoPersonSharp /> Sivanantham D</p></a>
                <a href="/employee"><p><IoPersonSharp /> Santhosh P</p></a>
                <a href="/employee"><p><IoPersonSharp /> Gopal K</p></a>
            </div>
            <div className="sb_footer-links-div">
                <h4>Nutri<span className='vision'>Vision</span></h4>
                <a href="/about"><p>About</p></a>
                <a href="/employee"><p>Press</p></a>
                <a href="/employee"><p>Career</p></a>
                <a href="/employee"><p>Contact</p></a>
            </div>
            <div className="sb_footer-links-div">
                <h4>Follow on</h4>
